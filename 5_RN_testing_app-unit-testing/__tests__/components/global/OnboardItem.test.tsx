...
describe('OnboardItem', () => {
  const mockOnPressFirst = jest.fn(); // "jest.fn()" provides a way to verify the behavior of code that relies on functions without executing the real function logic.
